...
class Model(object):
    ...
    def bottleneck_block(inputs, filters, is_training, 
                         projection_shortcut, strides, data_format):
        '''Bottleneck block variant for residual networks with BN before
           convolutions.
        ...
        Args:
            ...
            filters: The number of filters for the first two convolutions. Note 
                ...
                filters.
            is_training: A Boolean for whether the model is in training or
